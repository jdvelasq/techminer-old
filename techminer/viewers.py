...
#             "arg": "value",
#             "desc": "Term:",
#             "widget": widgets.Dropdown(options=[], layout=Layout(width=WIDGET_WIDTH),),
#         },
#         # 2
#         {
#             "arg": "title",
...
#             "desc": "Column:",
#             "widget": widgets.Dropdown(
#                 options=COLUMNS, value=COLUMNS[0], layout=Layout(width=WIDGET_WIDTH),
#             ),
#         },
#         # 1
#         {
...
#             "arg": "title",
#             "desc": "Title:",
#             "widget": widgets.Select(options=[], layout=Layout(width="500px"),),
#         },
#     ]
#     # -------------------------------------------------------------------------
#     #
...
#         [widgets.Label(value=controls[0]["desc"]), controls[0]["widget"],]
#     )

#     grid[2, 0] = widgets.VBox(
#         [widgets.Label(value=controls[1]["desc"]), controls[1]["widget"]]
#     )
...
#         [widgets.Label(value=controls[3]["desc"]), controls[3]["widget"]]
#     )

#     grid[1:3, 2:] = widgets.VBox(
#         [widgets.Label(value=controls[4]["desc"]), controls[4]["widget"]]
#     )
